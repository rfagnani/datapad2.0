  ...
  en: {
    translation: {
      ...
      admin: {
        ...
        licenseRequests: {
          navLabel: 'Solicitações de licenças',
          eyebrow: 'Operações de parceiros',
          title: 'Gestão de solicitações de licenças',
          subtitle: 'Revise e aprove as solicitações dos clientes.',
          pendingReviews: '{{count}} revisões pendentes',
          ...
          table: {
            title: 'Solicitações de licenças',
            ...
            approve: 'Aprovar',
            reject: 'Rejeitar',
            view: 'Ver detalhes da solicitação',
            empty: 'Nenhuma solicitação encontrada para os filtros.'
          },
          statuses: {
        ...
        licenseRequests: {
          navLabel: 'Solicitudes de licencias',
          eyebrow: 'Operaciones con partners',
          title: 'Gestión de solicitudes de licencias',
          subtitle: 'Revise y apruebe las solicitudes de los clientes.',
          pendingReviews: '{{count}} revisiones pendientes',
          ...
          table: {
            ...
            approve: 'Aprobar',
            reject: 'Rechazar',
            view: 'Ver detalles de la solicitud',
            empty: 'No hay solicitudes para los filtros seleccionados.'
          },
          statuses: {
          ...
          actions: {
            ...
            exported: 'Informe exportado correctamente.',
